    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <!-- Home, Cart, Checkout -->
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/TurningPage/home.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/TurningPage/shop/index.php">Shop</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/TurningPage/shop/cart.php">Cart</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/TurningPage/shop/checkout.php">Checkout</a>
                </li>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <?php else: ?>
                    <li class="nav-item">
                        <span class="navbar-text"><?= htmlspecialchars($_SESSION['email']) ?></span>
                    </li>
